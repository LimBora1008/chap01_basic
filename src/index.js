...
/*
  ...
  리액트 컴포넌트를 작성할 때 필요한 기능을 가져오기 위한 import문 이다
  React는 리액트 라이브러리의 핵심 기능을 포함하는 객체이다
  이를 사용하여 리액트 컴포넌트를 작성하고, JSX를 렌더링하고, 기타 리액트 관련 기능을 활용할 수 있다
*/
import React from 'react';
// node_modules 폴더에서 'react-dom' 패키지의 ReactDOM 객체를 가져오는 구문
// ReactDOM은 React 애플리케이션을 실제 DOM에 렌더링하는 역할 
...
root.render(
  // <React.StrictMode> : 코드가 잘못되었는지 판단하여 오류 메시지를 보여주는 컴포넌트
  <React.StrictMode>
    <App />
  </React.StrictMode>
);
// 위의 두 줄을 줄여서 다음과 같이 사용하는 기술
